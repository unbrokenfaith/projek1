            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="">
                            <a href="/petugas/kategori" class="btn btn-outline-primary ml-3">
                                < Kembali</a>
                        </div>
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h4 class="h3 mb-0 mt-3 text-gray-800">Tambah Data Kategori</h4>
                        </div>
                        <div class="card p-3 shadow">
                            <form action="/kategoripetugas/save" method="post" enctype="multipart/form-data">
                                <?=csrf_field();?>
                                <div class="mb-3">
                                    <label for="NamaKategori" class="form-label-f">Nama Kategori</label>
                                    <input type="text" class="form-control form-control-user <?=(session('errNamaKategori')) ? 'is-invalid' : '';?>" id="NamaKategori" name="NamaKategori" value="<?=old('NamaKategori');?>">
