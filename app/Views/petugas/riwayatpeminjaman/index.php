                ...
                <div class="row">
                    <div class="col">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="/generatelaporan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Laporan</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($pm['StatusPeminjaman'] == 1) : ?>
                                                        <form action="/petugas/riwayatpeminjaman/kembalikan/<?= $pm['PeminjamanID']; ?>" method="post">
