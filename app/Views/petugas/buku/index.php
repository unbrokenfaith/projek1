                ...
                <div class="row">
                    <div class="col">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="/petugas/buku/create" class="btn btn-outline-primary me-md-3">Tambah Data</a>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($buku as $b): ?>
                                        <tr>
                                            <th scope="row"><?=$i++;?></th>
                                            <td><img src="/img/<?=$b['Sampul'];?>" alt="" class="sampul" width="80px"></td>
                                            <td><?=$b['Judul'];?></td>
                                            ...
                                            <td><?=$b['Stok'];?></td>
                                            <td>
                                                <a href="/petugas/buku/edit/<?=$b['BukuID'];?>" class="btn btn-warning">Ubah</a> |

                                                <form action="/bukupetugascontroller/<?=$b['BukuID'];?>" method="post" class="d-inline">
                                                    <?=csrf_field();?>
