            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="">
                            <a href="/admin/user" class="btn btn-outline-primary ml-3">
                                < Kembali</a>
                        </div>
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h4 class="h3 mb-0 mt-3 text-gray-800">Edit Data User</h4>
                        </div>
                        <div class="card p-3 shadow">
                            <form action="/user/update/<?=$petugas['UserID'];?>" method="post" enctype="multipart/form-data">
                                <?=csrf_field();?>
