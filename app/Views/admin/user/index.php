                ...
                <div class="row">
                    <div class="col">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="/admin/user/create" class="btn btn-outline-primary me-md-3">Tambah Data</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($user as $u): ?>
                                        <tr>
                                            ...
                                            <td><?=$u['Email'];?></td>
                                            <td>
                                                <a href="/admin/user/edit/<?=$u['UserID'];?>" class="btn btn-warning">Ubah</a> |

                                                <form action="/user/<?=$u['UserID'];?>" method="post" class="d-inline">
                                                    <?=csrf_field();?>
