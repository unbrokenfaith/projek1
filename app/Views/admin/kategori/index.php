                ...
                <div class="row">
                    <div class="col">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="/admin/kategori/create" class="btn btn-outline-primary me-md-3">Tambah Data</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($kategori as $k): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/kategori/edit/<?=$k['KategoriID'];?>" class="btn btn-warning">Ubah</a> |

                                                <form action="/kategori/<?=$k['KategoriID'];?>" method="post" class="d-inline">
                                                    <?=csrf_field();?>
