...
class BukupetugasController extends BaseController
{
    protected $bukuModel;
    ...
    public function create()
    {
        ...
        return view('/petugas/buku/create', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$valid) {
            ...
            return redirect()->to(base_url('/petugas/buku/create'))->withInput();
        } else {
            //  Simpan data buku
            $this->bukuModel->save([
    ...
    public function update($id)
    {
        ...
        if (!$valid) {
            ...
            session()->setFlashdata($sessErr);
            return redirect()->to('/bukupetugascontroller/update/' . $this->request->getVar('BukuID'))->withInput();
        } else {
            //  Simpan data buku
            $this->bukuModel->save([
                'BukuID' => $id,
