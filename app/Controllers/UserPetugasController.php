...
class UserPetugasController extends BaseController
{
    protected $authModel;
    ...
    public function index(): string
    {
        ...
        return view('/petugas/user/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('/petugas/user/create', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$valid) {
            ...
            return redirect()->to('/petugas/user/create' . $this->request->getVar('UserID'))->withInput();
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('/petugas/user/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if (!$valid) {
            ...
            session()->setFlashdata($sessErr);
            return redirect()->to('/petugas/user/edit/' . $id)->withInput();
        } else {
            //  Simpan data petugas
            $this->authModel->save([
                'UserID' => $id,
